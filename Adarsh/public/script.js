...
btn.addEventListener('click', async function (e) {
    ...
    let resp = await axios.post('http://localhost:3000/backend/save', { id,name, age, email })
...
btn6.addEventListener('click', async function (e) {
    ...
    let resp = await axios.patch('http://localhost:3000/backend/update', {id,name, age, email})
...
let btn2 = document.querySelector('.btn2')
        btn2.addEventListener('click', async function (e) {
            ...
            let resp = await axios.get('http://localhost:3000/backend/show')
            console.log(resp.data)
        ...
        btn3.addEventListener('click', async function (e) {
            ...
            let resp = await axios.get('http://localhost:3000/backend/ascend')
        ...
        btn4.addEventListener('click', async function (e) {
            ...
            let resp = await axios.get('http://localhost:3000/backend/desc')
...
btn5.addEventListener('click', async function (e) {
    ...
    let resp = await axios.delete('http://localhost:3000/backend/del', {data:{id}})
